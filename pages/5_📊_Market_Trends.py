...
# ... (rest of your initial code for the page, including title, info, ticker input, date inputs) ...
    ...
    if market_ticker:
        with st.spinner(f"Fetching historical data for {market_ticker}..."):
            try:
                ...
                # --- CRITICAL FIX: Ensure this block is present and correct ---
                if data.empty:
                    ...
                    return # <--- This is the key: Exit if no data is found
                ...
                # These will now only be called if 'data' is not empty
                ...
                # ... (rest of your AI summary data capture) ...
