...
import numpy as np
import plotly.graph_objects as go # Essential for creating the candlestick chart
    ...
    with st.spinner(f"Fetching historical data for Nifty 50 ({NIFTY_TICKER})..."):
        try:
            ...
            if data.empty:
                ...
                # Optional: Update session state for AI summary if needed for this page
            ...
            for col in ['Open', 'High', 'Low', 'Close', 'Adj Close', 'Volume']:
                if col in data.columns:
                    ...
                    data[col] = data[col].fillna(0) # Fill any remaining NaNs with 0 if necessary
